...
\indent This approach can also be extended to existing video
...
is used as HAAR descriptor. Further, the same authors have provided new
concept of image representation as integral image.  Pixel value at any
location in an integral image is sum of all the pixels above and left of
that pixel.  These can be computed with very few operations per pixel.
Integral image representation helps in computation of HAAR like features
in constant time.\\
\indent Work by Viola and Jones in~\cite{17} was primarily used for
...
select a small set of features out of all HAAR like features and to
...
the above limitations. Jones and snow~\cite{26} have further improved
...
\indent In chapter 3 we give a summary of the work done and have
analyzed the results obtained in our approach.\\
\indent At the end in chapter 4 we address remaining issues
