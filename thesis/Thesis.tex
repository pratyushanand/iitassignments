...
of MS(R), in Department of Electrical Engineering, Indian
...
must also thank my employer M/s ST Microelectronics for allowing me to
pursue research on part time basis.

Last but not least, I would like to thank my wife, son and parents for
their continuous support for providing me free time to complete this job.
\\
\\
\begin{flushright}
...
\input{./Chapters/chap2} %methodology and approach

\input{./Chapters/chap3} %results and conclusion

\input{./Chapters/chap4} %future work
