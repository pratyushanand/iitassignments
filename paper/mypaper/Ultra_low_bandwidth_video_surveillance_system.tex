...
We get several noise object in the extracted foreground. They are
cleaned by morphological erosion operation followed by dilation
operation. Further all moving contours are separated out by using
opencv library ~\cite{12} function cvFindContours.

Star skeletonization method has been used to find extreme point on 
moving contours.Following steps have been used to identify types of
each moving contours.
\begin{enumerate}
